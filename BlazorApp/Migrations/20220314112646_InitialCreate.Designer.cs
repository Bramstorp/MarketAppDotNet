...
namespace BlazorApp.Migrations
{
    ...
    [Migration("20220314112646_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorApp.Bed", b =>
                {
            ...
            modelBuilder.Entity("BlazorApp.Crop", b =>
                {
            ...
            modelBuilder.Entity("BlazorApp.CropAssignment", b =>
                {
            ...
            modelBuilder.Entity("BlazorApp.Garden", b =>
                {
                    b.Property<int>("GardenId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorApp.Bed", b =>
                {
                    b.HasOne("BlazorApp.Garden", "Garden")
                        .WithMany("Beds")
            ...
            modelBuilder.Entity("BlazorApp.CropAssignment", b =>
                {
                    b.HasOne("BlazorApp.Bed", "Bed")
                        .WithMany("CropAssignments")
                        .HasForeignKey("BedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorApp.Crop", "Crop")
                        .WithMany("CropAssignments")
